...
import com.arkonq.pixelweather.model.CurrentWeatherModel
...
internal class WeatherAdapter(
    ...
    internal inner class CurrentWeatherHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            context = itemView.context
            currentTempTv = itemView.findViewById(R.id.current_temp_tv)
            tempMinTv = itemView.findViewById(R.id.temp_min_tv)
            tempMaxTv = itemView.findViewById(R.id.temp_max_tv)
            cityTv = itemView.findViewById(R.id.city_tv)
            countryTv = itemView.findViewById(R.id.country_tv)
            descriptionTv = itemView.findViewById(R.id.description_tv)
            iconImage = itemView.findViewById(R.id.icon_iv)
        }

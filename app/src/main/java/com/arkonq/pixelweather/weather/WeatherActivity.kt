...
import com.arkonq.pixelweather.PixelWeatherApplication
import com.arkonq.pixelweather.R
import com.arkonq.pixelweather.common.BasePresenterActivity
import com.arkonq.pixelweather.common.PresenterFactory
import com.arkonq.pixelweather.model.FiveDayForecastModel
import com.arkonq.pixelweather.model.WeatherReport
import com.arkonq.pixelweather.utils.AppUtils
import com.arkonq.pixelweather.utils.IconUrlUtils
import com.arkonq.pixelweather.utils.KeyboardUtils
import java.util.*
...
class WeatherActivity : BasePresenterActivity<WeatherPresenter, Weather.View>(), Weather.View {
    ...
    override fun showWeatherReport(weatherReport: WeatherReport) {
        ...
        linearLayout.background = applicationContext.getDrawable(R.drawable.application_background)
